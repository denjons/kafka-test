...
public class BasicClient {
     ...
     * @return Response object
     */
    public Response postFor(String body, String url, MediaType accept, MultivaluedMap<String, Object> headers) {
        Client client = ClientBuilder.newClient();
        WebTarget target = client.target(url);
        ...
        if (headers != null) {
            ...
            requestResult = target.request(accept).post(Entity.entity(body, MediaType.APPLICATION_JSON));
        }
     ...
     * @return Response object
     */
    public Response postFor(String body, String url, MediaType accept) {
        return postFor(body, url, accept, null);
